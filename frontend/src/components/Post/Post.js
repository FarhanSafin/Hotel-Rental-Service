        ...
        firebase.auth().currentUser.getIdToken(true)
            .then((idToken) => {
                ...
                axios.post('http://127.0.0.1:6200/api/reservation/create', null,
                    ...
                    .then(res => {
                        console.log(res)
                        alert("Successfully Reserved the hotel.");
                        window.location.reload(); 
                    })
                    .catch(error => {
                        this.setState({ date: null })
                        console.table(error);
                        alert("The date you selected are already reserved or partially reserved. Please select another date or another hotel.");
                    })
            })
            .catch(error => {
                console.log(error);
                    ...
                    <div className="container mt-5">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4" >
                                <Card raised>
                                    <CardContent>
                                        <h5 className="mt-1 " >{info.pricePerNight}৳ Per Night</h5>
                                        <p className="mt-1 " >{totalNights} Nights X {info.pricePerNight} ৳ = Total {totalCost} ৳</p>
